...
import type { ModalAddArticleProps } from '@/types/modal';
import {
  Description,
  Field,
  Input,
    ...
    <Modal
      ...
      footer={(
        <div className="flex w-full justify-between">
          ...
          <button
            onClick={onSubmit}
            className="flex cursor-pointer items-center gap-2 rounded-xl bg-green-600 px-6 py-2.5 font-medium text-white transition-all duration-200 hover:bg-green-700 focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50"
            disabled={isLoading}
            type="submit"
          >
            {isLoading
